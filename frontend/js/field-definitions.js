...
export const LEAD_FIELDS = [
  ...
  field("status", "状态", "basic", "select", { required: true, options: LEAD_STATUSES }),
  ...
  field("projectDomain", "项目领域", "requirement", "text", { maxLength: 160 }),
  field("projectType", "项目类型", "requirement", "text", { maxLength: 160 }),
  field("technologyType", "技术类型", "requirement", "text", { maxLength: 160 }),
  field("productType", "产品类型", "requirement", "text", { maxLength: 160 }),
  field("productName", "产品名称", "requirement", "text", { maxLength: 240 }),
  ...
  field("salesOwnerUserId", "销售负责人", "commercial", "user"),
  field("solution", "方案", "solution", "textarea", { maxLength: 16_000, wide: true }),
  field("latestProgress", "最近进展", "solution", "textarea", { maxLength: 16_000, wide: true }),
  field("followupOwnerUserId", "跟进负责人", "solution", "user"),
  field("nextFollowupAt", "下一次跟进", "solution", "datetime-local"),
