...
function renderOrganizationActions(organization) {
  return `<div class="table-actions"><button class="btn btn-small" data-org-task="${esc(organization.id)}" data-crm-permission="crm.task.create">创建任务</button><button class="btn btn-small" data-org-nurture="${esc(organization.id)}" data-crm-permission="crm.organization.nurture.manage">开始孵化</button><button class="btn btn-small" data-view-org="${esc(organization.id)}">查看</button></div>`;
}
