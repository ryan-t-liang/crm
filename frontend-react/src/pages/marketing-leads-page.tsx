...
const statusLabels = marketingLeadStatusLabels as Record<MarketingLeadStatus, string>;
...
function FormSection({ title, children }: { title: string; children: React.ReactNode }) {
  return <section className="crm-form-section rounded-xl border bg-card p-5"><h3 className="mb-4 border-b pb-3 text-sm font-semibold">{title}</h3>{children}</section>;
}
