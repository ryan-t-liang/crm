...
type NavItem = {
  ...
  countKey?: "organizations" | "contacts" | "leads"
}
...
const navGroups: Array<{ label: string; items: NavItem[] }> = [
  {
    label: "概览",
    items: [
      { label: "Dashboard", route: "dashboard", icon: LayoutDashboard, anyPermissions: ["crm.dashboard.self.view", "crm.dashboard.management.view"] },
    ],
  },
  {
    label: "客户管理",
    items: [
      ...
      { label: "线索", route: "leads", icon: Goal, permission: "crm.lead.view", countKey: "leads" },
    ],
  },
  {
    label: "客户运营",
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild className="h-11 data-[slot=sidebar-menu-button]:hover:bg-transparent">
              <a href="#dashboard" aria-label="返回 Dashboard">
